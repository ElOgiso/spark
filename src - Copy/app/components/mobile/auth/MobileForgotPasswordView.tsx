...
export function MobileForgotPasswordView({ onBack }: MobileForgotPasswordViewProps) {
  ...
  return (
    <div className="fixed inset-0 w-full h-[100dvh] bg-background text-foreground flex flex-col justify-between p-6 z-50 overflow-y-auto select-none antialiased">
      <div>
        <button
          type="button"
          onClick={onBack}
      ...
      {sent ? (
        <div className="my-auto py-8 text-center space-y-4 px-2">
