              ...
              <WhySparkRecommends
                details={{
                  ...
                  evidence: [
                    ...
                    `Audience alignment matches critical creator trigger: "${spark.audienceEmotion}".`,
                    `High brand consistency verified against ${brand?.name || "brand"} rules (Fit: ${spark.brandFitScore}%).`,
                  ...
                  brandRules: brand?.name ? [`${brand.name} Rule #1`, "Authority Rules"] : ["Brand Rule #1", "Authority Rules"]
                }}
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="p-3 rounded-xl bg-background border border-border">
                      ...
                      <p className="text-sm font-medium">{spark.audienceEmotion}</p>
                    </div>
                    <div className="p-3 rounded-xl bg-background border border-border">
                      <p className="text-xs text-muted-foreground mb-1">Difficulty</p>
                      <p className="text-sm font-medium">{spark.difficulty}</p>
                    </div>
                  </div>
                  <div className="p-3 rounded-xl bg-background border border-border">
                    <p className="text-xs text-muted-foreground mb-1">Expected Retention Reason</p>
                    <p className="text-sm font-medium leading-relaxed">{spark.expectedRetention}</p>
                  </div>
                  <div className="p-3 rounded-xl bg-background border border-border">
                  ...
                  <div className="space-y-3 mb-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <div className="p-3.5 rounded-xl bg-background border border-border">
                        ...
                        <p className="text-xs leading-relaxed text-foreground/90">
                          Resonates with <span className="text-accent-foreground font-medium">{spark.audienceEmotion}</span> triggers targeting your active audience demographics.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="p-3.5 rounded-xl bg-background border border-border">
                        ...
                        <p className="text-xs leading-relaxed text-foreground/90">
                          Directly aligns with your <span className="font-medium text-foreground">{brand?.name || "brand"}</span> core pillars, matching existing brand authority rules.
                        </p>
                      </div>
