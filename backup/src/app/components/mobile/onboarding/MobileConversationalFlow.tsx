        ...
        <AnimatePresence mode="wait">
          ...
          {step === "character-scanning" && (
            ...
            >
              ...
              />
              <div className="p-4 rounded-2xl bg-card/60 border border-blue-500/30 backdrop-blur-md w-full text-xs text-blue-200/80 space-y-1">
          ...
          {step === "initialization" && (
            ...
            >
              ...
              <div className="bg-card/80 border border-border/80 p-4 rounded-2xl backdrop-blur-md space-y-2.5 w-full text-left text-xs">
                {[
