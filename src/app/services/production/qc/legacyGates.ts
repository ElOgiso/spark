/**
 * Legacy Phase 0/1 structural QC gates — preserved for backward compatibility.
 * Intelligent multi-dimensional QC lives in Phase 5 modules.
 */
...
export function finalMasterGate(params: { masterUrl?: string; qcScores: number[] }): QcGateResult {
  ...
  return {
    ...
    failures,
    recommendedAction: failures.includes("master_missing")
      ? "rerender_same_model"
      : failures.length
