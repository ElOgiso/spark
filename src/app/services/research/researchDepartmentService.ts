...
export class ResearchDepartmentService {
  ...
  static processVideoResearch(
    ...
    const spark: ViralSpark = {
      ...
      views: videoResearch.viewCount ? videoResearch.viewCount.toLocaleString() : "Live Analysis",
      velocity: "High",
      ...
      whyNow: `Deep AI Video Understanding identified viral hook & storytelling patterns in "${videoResearch.title}".`,
