      ...
      <div className="max-w-md w-full bg-card border border-border/80 p-8 rounded-3xl shadow-2xl backdrop-blur-xl relative z-10 space-y-6">
        ...
        <div className="flex items-center justify-between border-b border-border/50 pb-4">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-lg bg-[#BA00C0]/20 border border-[#BA00C0]/30 flex items-center justify-center">
          ...
          <button
            ...
            className="text-xs text-fuchsia-400 hover:text-fuchsia-300 transition-colors flex items-center space-x-1 font-medium bg-fuchsia-500/10 px-2.5 py-1 rounded-lg border border-fuchsia-500/30"
          >
